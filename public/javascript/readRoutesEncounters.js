    ...
    for (let i = 0; i < allEncounters.length; i++) {
      ...
      */
      function deleteButton(i, routeID){
        ...
        //
        tableCellDeleteButton.innerHTML = tableCellDeleteButton.innerHTML + "<form action='/item/single' method='POST' id='deleteRouteForm'><input type='hidden' name='routeID' value='"+routeID+"'/><input type='submit' id='deleteButton' value='Delete'/></form>";

// " <a href='item/single?_id="+routeID+"'>delete</a>"
      }
