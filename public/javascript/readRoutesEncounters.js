...
// TODO: DIESE DATEI VERMUTLICH IN INDEX.JS ÜBERFÜHREN
...
.fail (function (xhr, status, error) {
  ...
  JL("ajaxDisplayAllTimeout1").fatal("ajax: '/displayAll' timeout");
});
...
function getAllEncountersAndShow() {
  ...
  .fail (function (xhr, status, error) {
    ...
    // WAS BEI ANDEREN ERRORS?
    // NOTFALLS LÖSCHEN, BEI ALLEN AJAX
    JL("ajaxEncountersGetAllTimeout").fatal("ajax: '/encounter/getAll' timeout");
  });
}
...
class WeatherRequest
{
  ...
  * When it is called, ........ AND STATUS AND STATE ARE .................... it writes the weather into the table and creates an infoRequest.
  */
  statechangecallback()
  {
  ...
  */
  errorcallback(e) {
    ...
    else
    {
      ...
      JL("weatherRequestError").fatalException("errorcallback", e);
    }
  }
