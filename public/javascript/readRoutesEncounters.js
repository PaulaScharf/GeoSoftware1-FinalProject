    ...
    */
    function showAllRoutesOnStartingPage() {
      ...
      for (let i = 0; i < allRoutes.length; i++) {
        ...
        createAndWriteTableWithSevenCells(i + 1, allRoutes[i][0].creator, allRoutes[i][0].name, allRoutes[i][0].date, allRoutes[i][0].time, allRoutes[i][0].userRouteType, "routesTable");
    ...
    function fillEncountersTable() {
      ...
      for (let i = 0; i < allEncounters.length; i++) {
        ...
        if (currentEncounter[1] === true) {
          ...
          //
          createAndWriteTableWithThreeCells(i + 1, currentEncounter[2].firstRoute + 1, currentEncounter[2].secondRoute + 1, "encountersTable");

          // if the encounter is new, then create a new weather and a new terrain request
